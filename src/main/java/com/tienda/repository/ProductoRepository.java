...
public interface ProductoRepository extends JpaRepository<Producto, Long> {
    ...
    //Consulta JPQL ara recuperar los productos entre un rango de precio, ordenados por precio.
    ...
    //Consulta SQL ara recuperar los productos entre un rango de precio, ordenados por precio.
